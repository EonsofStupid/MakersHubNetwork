...
/**
 * Unified authentication section component for the main navigation
 * Handles both signed in and signed out states
 */
export function AuthSection() {
  ...
  // Show authenticated state with UserMenu
  if (isAuthenticated && user) {
    return <UserMenu />;
  }

  // Show login sheet for unauthenticated users
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent
        ...
        style={{
          clipPath: "polygon(20px 0, 100% 0, 100% 100%, 0 85%)",
            ...
            {hasAdminAccess() && (
              <div className="pt-2">
                <Button
                  variant="outline"
                  className={cn(
                    "w-full bg-primary/5 hover:bg-primary/10 shimmer",
