...
export function ThemeList() {
  ...
  useEffect(() => {
    const fetchThemes = async () => {
      try {
        ...
        // Transform raw database rows to Theme models
  ...
  const createTheme = async () => {
    ...
    try {
      ...
      // Create a properly structured component_tokens array
      ...
      // Transform the returned data to a Theme model
  ...
  const duplicateTheme = async (themeId: string) => {
    ...
    try {
      ...
      // Transform to a proper Theme model
