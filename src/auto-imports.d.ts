...
declare global {
  ...
  const use-mobile: typeof import('./hooks/use-mobile')['default']
  const useAuth: typeof import('./hooks/useAuth')['useAuth']
  const useAuthAtoms: typeof import('./hooks/useAuthAtoms')['useAuthAtoms']
...
declare global {
  // @ts-ignore
  export type { CircuitBreaker } from './utils/CircuitBreaker'
  import('./utils/CircuitBreaker')
  // @ts-ignore
  export type { Theme, DesignTokens, TypographyTokens, ComponentTokens, ThemeEffects, ThemeEffect, ThemeToken, ThemeLogDetails } from './types/theme'
  import('./types/theme')
}
