 ...
 * Replaces the separate admin permissions in multiple locations
 */

// Define all application permissions as a type-safe object
...
// Create a type from the values in the APP_PERMISSIONS object
