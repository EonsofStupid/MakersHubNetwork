            ...
            <div className="relative z-10 p-6 space-y-6">
                ...
                >
                  ...
                  <div className="space-y-1">
                    <h3 className="text-xl font-bold text-primary animate-morph-header">
                      {user?.user_metadata?.display_name || profile?.display_name || "Anonymous Maker"}
                    </h3>
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-sm">{profile?.theme_preference || user?.user_metadata?.theme_preference || "Cyberpunk"}</p>
                </div>
                <div className="space-y-2">
                  <h4 className="text-sm font-medium text-muted-foreground">Motion</h4>
                  <p className="text-sm">{(profile?.motion_enabled || user?.user_metadata?.motion_enabled) ? "Enabled" : "Disabled"}</p>
                </div>
              </motion.div>
